...
export const ALGORITHMS: AlgorithmProfile[] = [
  {
    ...
    detail:
      ...
      "\n\n均衡排产优化：每期求解完成后，自动对 A/B 和 C/D 产品对进行均衡微调，" +
      "通过在各班次之间交换产量（多的-1、少的+1），在约束满足的前提下让每期 A产总和≈B产总和、C产总和≈D产总和。" +
      "二加产量求解优先级：机器系数优先最小，其次可用人数最小。",
    traits: {
  ...
  },
  {
    ...
    detail:
      ...
      "\n\n均衡排产优化：尾部优化后，自动对 A/B 和 C/D 产品对进行均衡微调，" +
      "通过在各班次之间交换产量，在约束满足的前提下让每期 A产总和≈B产总和、C产总和≈D产总和。" +
      "二加产量求解优先级：机器系数优先最小，其次可用人数最小。",
    traits: {
  ...
  },
  {
    ...
    detail:
      ...
      "\n\n均衡排产优化：受限优化后，自动对 A/B 和 C/D 产品对进行均衡微调，" +
      "通过在各班次之间交换产量，在约束满足的前提下让每期 A产总和≈B产总和、C产总和≈D产总和。" +
      "二加产量求解优先级：机器系数优先最小，其次可用人数最小。",
    traits: {
